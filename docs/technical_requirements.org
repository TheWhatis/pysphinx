...
* TODO Список задач
1. [ ] Дописать *Стек Пакета*
2. [ ] Модуль для парсинга конструкций python
   1. [ ] Python скрипт, который возвращает данные
      - [ ] Данные функций
      - [ ] Данные классов
      - [ ] Данные методов классов
   2. [ ] Elisp функция которая отправляет конструкции и принимает данные конструкций
   3. [ ] Elisp модуль, который получает данные конструкций и создает шаблон
      - [ ] Шаблон функций
      - [ ] Шаблон классов
